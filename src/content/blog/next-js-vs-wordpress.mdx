...
## FAQ : Next.js vs WordPress

**Next.js est-il gratuit ?**
Oui. Next.js est open source. L'hébergement sur Vercel est gratuit pour les petits sites. Les coûts viennent du développement, pas de la technologie.

**Peut-on migrer de WordPress vers Next.js ?**
Oui. Le contenu WordPress peut être exporté et restructuré pour Next.js. C'est un projet de migration qui prend généralement deux à quatre semaines selon la taille du site.

**WordPress est-il mort ?**
Non. WordPress reste pertinent pour les blogs, les sites éditoriaux et les petits e-commerces. Mais pour les projets où la performance et la sécurité comptent, les alternatives comme Next.js gagnent du terrain.

**Faut-il un développeur pour maintenir un site Next.js ?**
Pour les mises à jour de contenu simples, un CMS headless (comme Strapi ou Sanity) peut être connecté à Next.js. Le client modifie son contenu dans une interface visuelle, le site se met à jour automatiquement.
